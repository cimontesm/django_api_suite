...
SECRET_KEY = "django-insecure-$ychh5b5q#0cimstv859fm0*)j+*ag_n8frs4hwvdj+dsdogp+"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['cimontes.pythonanywhere.com']
...
firebase_admin.initialize_app(FIREBASE_CREDENTIALS_PATH, {
   'databaseURL': 'https://landing-e75c7-default-rtdb.firebaseio.com/'
})